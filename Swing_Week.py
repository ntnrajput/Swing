...
nifty_200_symbols = ['ITC.NS', 'TITAN.NS','TECHM.NS','RITES.NS','ULTRACEMCO.NS','MARUTI.NS','BAJFINANCE.NS','COALINDIA.NS','APOLLOHOSP.NS',
                     ...
                     'VBL.BO','VEDL.BO','WIPRO.BO','YESBANK.BO','ZOMATO.BO','ZYDUSLIFE.BO','360ONE.NS', ' ABCAPITAL.NS','JIOFIN.NS','IRFC.NS','JSWSTEEL.NS','VBL.NS','TORNTPHARM.NS',
                     ...
                     'ESCORTS.BO','DEEPAKNTR.BO','METROBRAND.BO']  # Replace with actual symbols
