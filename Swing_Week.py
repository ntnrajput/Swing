...
nifty_200_symbols = ['ITC.NS', 'TITAN.NS','TECHM.NS','RITES.NS','ULTRACEMCO.NS','MARUTI.NS','BAJFINANCE.NS','COALINDIA.NS','APOLLOHOSP.NS',
                     ...
                     'SBIN.NS','LICI.NS','HCLTECH.NS','KOTAKBANK.NS','ADANIENT.NS','AXISBANK.NS','SUNPHARMA.NS','ASIANPAINT.NS','NTPC.NS',
                     ...
                     'BAJAJ-AUTO.NS','M&M.NS','HAL.NS','DLF.NS','IOC.NS','LTIM.NS','TATASTEEL.NS','SIEMENS.NS','SBILIFE.NS',
                     'GRASIM.NS','PIDILITIND.NS','BEL.NS','HINDZINC.NS','PFC.NS','INDUSINDBK.NS','ADANIENSOL.NS','BRITANNIA.NS','HINDALCO.NS','ZOMATO.NS','BANKBARODA.NS',
                     ...
                     'EICHERMOT.NS','DIVISLAB.NS','ABB.NS','VEDL.NS','TVSMOTOR.NS','BPCL.NS','DABUR.NS','UNIONBANK.NS','SHREECEM.NS','DRREDDY.NS','HAVELLS.NS',
                     ...
                     'VBL.BO','VEDL.BO','WIPRO.BO','YESBANK.BO','ZOMATO.BO','ZYDUSLIFE.BO','TORNTPHARM.NS',
                     ...
                     'VINATIORGA.BO','KIMS.BO','MCX.BO','CIEINDIA.BO','SWANENERGY.BO','SUVENPHAR.BO','REDINGTON.BO','INTELLECT.BO','WHIRLPOOL.BO','NSLNISP.BO','CENTURYTEX.BO',
                     'RRKABEL.BO','APTUS.BO','GODFRYPHLP.BO','TTML.BO','PPLPHARMA.BO','ANANDRATHI.BO','INDIAMART.BO','JYOTHYLAB.BO','CESC.BO','SHYAMMETL.BO','ACE.BO',
                     'SCHNEIDER.BO','LAXMIMACH.BO','INOXWIND.BO','CHALET.BO','ARE&M.BO','IIFL.BO','ZEEL.BO','RBLBANK.BO','CGCL.BO','NCC.BO','TRITURBINE.BO','LAXMIMACH.BO',
                     'NAVINFLUOR.BO','HSCL.BO','INOXWIND.BO','CHALET.BO','OLECTRA.BO','ARE&M.BO','CONCORDBIO.BO','AFFLE.BO','KARURVYSYA.BO','WELSPUNLIV.BO','NUVAMA.BO',
                     'BLS.BO','VGUARD.BO','CAMS.BO','MANAPPURAM.BO','ABSLAMC.BO','JWL.BO','BASF.BO','ALOKINDS.BO','CHAMBLFERT.BO','GESHIP.BO','CLEAN.BO','RBLBANK.BO',
                     'POLYMED.BO','BLUEDART.BO','DCMSHRIRAM.BO','JINDALSAW.BO','WELCORP.BO','DATAPATTNS.BO','FSL.BO','J&KBANK.BO','FINPIPE.BO','HFCL.BO','PVRINOX.BO',
                     'FINCABLES.BO','CHENNPETRO.BO','ASAHIINDIA.BO','MGL.BO','ZENSARTECH.BO','FINEORG.BO','BIKAJI.BO','HONASA.BO','SOBHA.BO','ASTRAZEN.BO','VTL.BO',
                     'IEX.BO','HBLPOWER.BO','KSB.BO','TEJASNET.BO','TITAGARH.BO','MAHSEAMLES.BO','HAPPSTMNDS.BO','GRAPHITE.BO','INGERRAND.BO','GRINFRA.BO','AMBER.BO','SPLPETRO.BO',
                     'ECLERX.BO','ERIS.BO','TANLA.BO','SWSOLAR.BO','DBREALTY.BO','BEML.BO','WESTLIFE.BO','SPARC.BO','PTCIL.BO','KIRLOSENG.BO','BBTC.BO','RAINBOW.BO','JKTYRE.BO',
                     'RKFORGE.BO','RAYMOND.BO','BAJAJELEC.BO','GMDCLTD.BO','ENGINERSIN.BO','BIRLACORPN.BO','AAVAS.BO','RAILTEL.BO','UTIAMC.BO','SANDUMA.BO','NUVOCO.BO',
                     'RHIM.BO','BIRET.BO','JPPOWER.BO','SFL.BO','INOXINDIA.BO','AKZOINDIA.BO','EQUITASBNK.BO','IBULHSGFIN.BO','AETHER.BO','PNCINFRA.BO','INFIBEAM.BO',
                     'MMTC.BO','INDIGRID.BO','NEWGEN.BO','GRANULES.BO','ANANTRAJ.BO','ANURAS.BO','CEATLTD.BO','LEMONTREE.BO','KFINTECH.BO','ALKYLAMINE.BO','RTNINDIA.BO',
                     'EIDPARRY.BO','IFCI.BO','ROUTE.BO','TTKPRESTIG.BO','CANFINHOME.BO','CAPLIPOINT.BO','JKLAKSHMI.BO','GODREJAGRO.BO','CUB.BO','PCBL.BO','SCI.BO',
                     'ELECON.BO','UJJIVANSFB.BO','ZYDUSWELL.BO','LATENTVIEW.BO','GPIL.BO','CERA.BO','RATEGAIN.BO','ELECTCAST.BO','GNFC.BO','MAPMYINDIA.BO','KPIGREEN.BO',
                     'JUBLPHARMA.BO','GPPL.BO','MINDACORP.BO','RENUKA.BO','GLS.BO','USHAMART.BO','NETWORK18.BO']  # Replace with actual symbols
