...
nifty_200_symbols = ['ITC.NS', 'TITAN.NS','TECHM.NS','RITES.NS','ULTRACEMCO.NS','MARUTI.NS','BAJFINANCE.NS','COALINDIA.NS','APOLLOHOSP.NS',
                     ...
                     'TATAMTRDVR.BO','TATAPOWER.BO','TATASTEEL.BO','TIINDIA.BO','TITAN.BO','TORNTPOWER.BO','TRENT.BO','TVSMOTOR.BO','UCOBANK.BO','ULTRACEMCO.BO','UNIONBANK.BO',
                     'VBL.BO','VEDL.BO','WIPRO.BO','YESBANK.BO','ZOMATO.BO','ZYDUSLIFE.BO','20MICRONS.NS','360ONE.NS','3IINFOLTD.NS','3MINDIA.NS','5PAISA.NS','63MOONS.NS','AARTIDRUGS.NS',
                     'AARTIIND.NS','AARTIPHARM.NS','AARTISURF.NS','AAVAS.NS','ABAN.NS','ABFRL.NS','ABSLAMC.NS','ACC.NS','ACCELYA.NS','ACE.NS','ACI.NS','ACLGATI.NS','ADANIENSOL.NS',
                     'ADFFOODS.NS','ADORWELD.NS','ADSL.NS','ADVANIHOTR.NS','ADVENZYMES.NS','AEGISCHEM.NS','AEGISLOG.BO','AEROFLEX.NS','AETHER.NS','AFFLE.NS','AGARIND.NS',
                     'AGI.NS','AGSTRA.NS','AHL.NS','AHLUCONT.NS','AIAENG.NS','AJANTPHARM.NS','AJMERA.NS','AKZOINDIA.NS','ALANKIT.NS','ALBERTDAVD.NS','ALEMBICLTD.NS','ALICON.NS','ALKEM.NS']  # Replace with actual symbols
